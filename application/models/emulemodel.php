...
class emuleModel extends baseModel{
  ...
  protected $_datatopicStruct = 'a.`id`,a.ourl, a.`cid`, a.`uid`, a.`name`, a.`collectcount`, ac.`keyword`, ac.`download`,ac.thund, ac.`vipdwurl`, a.`ptime`, a.`utime`, ac.`intro`, a.`cover`, a.`hits`';
